...
namespace MRGSP.ASMS.WebUI.Controllers
{
    public class AddressController : FarmersCruder<Address, AddressInput>
    {
        ...
        public AddressController(IBuilder<Address, AddressInput> builder, IFarmersEntityService<Address> service, IRepo<AddressInfo> addressInfoRepo) : base(builder, service)
        {
